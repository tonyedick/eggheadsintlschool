...
<aside class="main-sidebar">
    ...
    <div class="user-profile">
			<div class="ulogo">
              ...
              <img src="{{asset('backend/images/full logo white.svg')}}" alt="">
					 </div>
				</a>
			</div>
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">  
      ...
      @endif
        ...
        <li class="treeview {{ ($prefix == '/setups')?'active':'' }}" >
          <a href="#">
            <i data-feather="credit-card"></i> <span>School Setup</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('exam.term.view') }}"><i class="ti-more"></i>Exam Term</a></li>
            ...
            <li><a href="{{ route('designation.view') }}"><i class="ti-more"></i>Teacher Designation</a></li>
            <li><a href="{{ route('form.teacher.view') }}"><i class="ti-more"></i>Assign Form Teacher</a></li>
            <li><a href="{{ route('subject.teacher.view') }}"><i class="ti-more"></i>Assign Subject Teacher</a></li>
          </ul>
        </li>
        ...
        <li class="treeview {{ ($prefix == '/students')?'active':'' }}" >
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('registration.fee.view') }}"><i class="ti-more"></i>School Fee </a></li>
        ...
        <li class="treeview {{ ($prefix == '/marks')?'active':'' }}">
          ...
          <ul class="treeview-menu">
        <li class="{{ ($route == 'marks.entry.add')?'active':'' }}"><a href="{{ route('marks.entry.add') }}"><i class="ti-more"></i>Mid Term Entry</a></li> 
...
<li class="treeview {{ ($prefix == '/accounts')?'active':'' }}">
       ...
       <li class="treeview {{ ($prefix == '/reports')?'active':'' }}">
        ...
        <li class="{{ ($route == 'monthly.profit.view')?'active':'' }}"><a href="{{ route('monthly.profit.view') }}"><i class="ti-more"></i>Monthly-Yearly Profit</a></li> 
          ...
          <li class="{{ ($route == 'marksheet.generate.view')?'active':'' }}"><a href="{{ route('marksheet.generate.view') }}"><i class="ti-more"></i>Mid Term Report</a></li>
        ...
        <li class="header nav-small-cap">Lesson Planner</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="components_alerts.html"><i class="ti-more"></i>Lesson</a></li>
            <li><a href="components_badges.html"><i class="ti-more"></i>CBT</a></li>
          </ul>
        </li>

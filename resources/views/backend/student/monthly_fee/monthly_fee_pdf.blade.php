...
<table id="customers">
  ...
  <img src="{{ public_path() . $image_path }}" width="140" height="100">
...
@php 
$registrationfee = App\Models\FeeCategoryAmount::where('fee_category_id','9')->where('class_id',$details->class_id)->first();

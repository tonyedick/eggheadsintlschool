...
use App\Http\Controllers\Backend\Setup\ExamTermController;
use App\Http\Controllers\Backend\Setup\ExamTypeController;
use App\Http\Controllers\Backend\Setup\SchoolSubjectController;
use App\Http\Controllers\Backend\Setup\AssignSubjectController;
use App\Http\Controllers\Backend\Setup\DesignationController;
use App\Http\Controllers\Backend\Setup\AssignFormTeacherController;
use App\Http\Controllers\Backend\Setup\AssignSubjectTeacherController;
...
Route::prefix('setups')->group(function(){
    ...
    //Exam Term Routes
    Route::get('exam/term/view', [ExamTermController::class, 'ViewExamTerm'])->name('exam.term.view');

    Route::get('exam/term/add', [ExamTermController::class, 'ExamTermAdd'])->name('exam.term.add');

    Route::post('exam/term/store', [ExamTermController::class, 'StoreExamTerm'])->name('store.exam.term');

    Route::get('exam/term/edit/{exam_term_id}', [ExamTermController::class, 'EditExamTerm'])->name('edit.exam.term');

    Route::post('exam/term/update/{exam_term_id}', [ExamTermController::class, 'UpdateExamTerm'])->name('update.exam.term');
    ...
    //Assign Form Teacher Routes
    Route::get('form/teacher/view', [AssignFormTeacherController::class, 'ViewFormTeacher'])->name('form.teacher.view');

    Route::get('form/teacher/add', [AssignFormTeacherController::class, 'AddFormTeacher'])->name('form.teacher.add');

    Route::post('form/teacher/store', [AssignFormTeacherController::class, 'StoreFormTeacher'])->name('store.form.teacher');

    Route::get('form/teacher/edit/{id}', [AssignFormTeacherController::class, 'EditFormTeacher'])->name('form.teacher.edit');

    Route::post('form/teacher/update/{employee_id}', [AssignFormTeacherController::class, 'UpdateFormTeacher'])->name('update.form.teacher');

    Route::get('form/teacher/delete/{employee_id}', [AssignFormTeacherController::class, 'DeleteFormTeacher'])->name('form.teacher.delete');

    //Assign Subject Teacher Routes
    Route::get('subject/teacher/view', [AssignSubjectTeacherController::class, 'ViewSubjectTeacher'])->name('subject.teacher.view');

    Route::get('subject/teacher/add', [AssignSubjectTeacherController::class, 'AddSubjectTeacher'])->name('subject.teacher.add');

    Route::post('subject/teacher/store', [AssignSubjectTeacherController::class, 'StoreSubjectTeacher'])->name('store.subject.teacher');

    Route::get('subject/teacher/edit/{id}', [AssignSubjectTeacherController::class, 'EditSubjectTeacher'])->name('subject.teacher.edit');

    Route::post('subject/teacher/update/{employee_id}', [AssignSubjectTeacherController::class, 'UpdateSubjectTeacher'])->name('update.subject.teacher');

    Route::get('subject/teacher/delete/{employee_id}', [AssignSubjectTeacherController::class, 'DeleteSubjectTeacher'])->name('subject.teacher.delete');
